						...
						<c:forEach var="item" items="${model.listResult}">
							<tr>
								...
								<td><c:url var="updateNewURL" value="/admin/product/edit">
									...
									<c:url var="deleteCate" value="/admin/product/delete">
										<c:param name="id">${item.iD}</c:param>
									</c:url>
									...
									href='${updateNewURL}'><i class="fa fa-pencil-square-o"
										...
										<a id="deleteProduct" class="deleteProduct" data-target="#deleteP"
                                       data-toggle="modal"
...
<div class="modal fade" id="deleteP" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
